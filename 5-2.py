...
first = input('Введите первое число в шестнадцатеричном формате (цифры от 0 до F): ')
second = input('Введите второе число в шестнадцатеричном формате (цифры от 0 до F): ')
...
if k == 1:
  third.append('1')
#print(third[::-1]  # список ок разворачивается
с = third.reverse() # почему-то не разворачивается очередь
print(с)